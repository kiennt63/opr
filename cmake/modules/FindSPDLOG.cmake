# Try to find SPDLOG lib The following are set after configuration is done:
# SPDLOG_FOUND SPDLOG_INCLUDE_DIR SPDLOG_LIBRARY_DIR SPDLOG_LIBRARIES
...
if(SPDLOG_FOUND)
    list(APPEND SPDLOG_INCLUDE_DIR ${SPDLOG_PATH}/include)
    list(APPEND SPDLOG_LIBRARY_DIR ${SPDLOG_PATH}/lib)
